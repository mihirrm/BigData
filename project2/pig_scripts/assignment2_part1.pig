...
business_at_palo_alto = FILTER filter_business BY (full_address matches '.*Palo Alto, CA.*');

join_result = join average_rating by business_id, business_at_palo_alto by business_id;
